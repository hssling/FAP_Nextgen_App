...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_student_select_own'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_student_insert_own'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_student_update_own'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_student_delete_own'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_teacher_read_assigned'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'individual_assessments'
      AND policyname = 'individual_assessments_admin_all'
  ) THEN
